" THIS THEME IS ORIGINALLY BY JARED GORSKI
" I JUST MODIFIED IT TO FIT MY RICE
...
" Color Variables
" ==========================
let s:spaceBlack = {'gui': '#0e0e0e', 'cterm256': '232'}
let s:spaceBlack2 = {'gui': '0e0e0e', 'cterm256': '232'}
let s:spaceGray1 = {'gui': '#0e0e0e', 'cterm256': '238'}
let s:spaceGray2 = {'gui': '#0e0e0e', 'cterm256': '238'}
let s:spaceGray3 = {'gui': '#0e0e0e', 'cterm256': '238'}
let s:spaceGray4 = {'gui': '#0e0e0e', 'cterm256': '238'}
let s:spaceSteel = {'gui': '#0e0e0e', 'cterm256': '244'}
let s:spaceWhite = {'gui': '#0e0e0e', 'cterm256': '255'}
let s:spaceViolet = {'gui': '#0e0e0e', 'cterm256': '255'}
let s:spaceBlue = {'gui': '#0e0e0e', 'cterm256': '118'}
let s:spaceBlue2 = {'gui': '#0e0e0e', 'cterm256': '118'}
let s:spaceGreen = {'gui': '#0e0e0e', 'cterm256': '118'}
let s:spaceGoo = {'gui': '#0e0e0e', 'cterm256': '191'}
let s:spaceGold = {'gui': '#0e0e0e', 'cterm256': '220'}
let s:spaceOrange = {'gui': '#0e0e0e', 'cterm256': '202'}
let s:spaceRed = {'gui': '#0e0e0e', 'cterm256': '1'}
let s:spaceRed2 = {'gui': '#0e0e0e', 'cterm256': '196'}
